...
figure; plot(data.Timestamp,rawdata.Electrode1,data.Timestamp,rawdata.Electrode2, ...
             data.Timestamp,rawdata.Electrode3,data.Timestamp,rawdata.Electrode4);
...
%% Convert EEG times to movie times
